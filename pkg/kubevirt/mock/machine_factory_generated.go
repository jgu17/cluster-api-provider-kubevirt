...
func (m *MockMachineFactory) NewMachine(ctx *context0.MachineContext, client client.Client, namespace string, sshKeys *ssh.ClusterNodeSshKeys, networkDataSecret *corev1.Secret) (kubevirt.MachineInterface, error) {
	m.ctrl.T.Helper()
